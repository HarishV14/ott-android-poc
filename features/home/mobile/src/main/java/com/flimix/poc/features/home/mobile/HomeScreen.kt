package com.flimix.poc.features.home.mobile
...
import com.flimix.poc.features.home.mobile.blocks.CarouselBlock
import com.flimix.poc.features.home.mobile.blocks.HeroBlock
    ...
    Scaffold(
        ...
        Column(
            ...
            pageResponse.schema.blocks.forEach { block ->
                BlockRenderer(block = block, registry = registry, canvasContentWidth = canvasWidth)
            }
        }
    }
}
